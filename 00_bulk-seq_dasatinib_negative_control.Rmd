---
title: "Bulk Sequencing Analysis - Negative Control"
...
* Randomise gene names for negative control
```{r, echo = TRUE}
# Inspect counts
counts <- fcData[7:12]
...
# Create a randomised list of the gene names for negative control
randgenes <- sample(rownames(counts))
# Reassign these to the matrix
rownames(counts) <- randgenes
