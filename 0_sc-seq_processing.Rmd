...
cp -r ~/R/PhD_Thesis_Chapter_4/bash/runs/scDrugMice2023-pool1/ ~/R/PhD_Thesis_Chapter_4/bash/dasruns/
...
cd ~/R/PhD_Thesis_Chapter_4/bash/dasruns
...
```{bash}
# Navigate to the right directory
cd ~/R/PhD_Thesis_Chapter_4/bash/runs
...
* Pre-process the cellranger output for all samples
```{r}
# Load the CellRanger output.
mouse.dat.10X <- Read10X(data.dir = "~/R/PhD_Thesis_Chapter_4/bash/runs/aggAll/outs/count/filtered_feature_bc_matrix")
...
* Pre-process the cellranger output for dasatinib samples
```{r}
# Load the CellRanger output
das.dat.10X <- Read10X(data.dir = "~/R/PhD_Thesis_Chapter_4/bash/dasruns/aggAll/outs/count/filtered_feature_bc_matrix")
# Initialize the Seurat object with the raw (non-normalized data)
...
```{r}
# Dasatinib data
saveRDS(das.dat, "~/R/PhD_Thesis_Chapter_4/data/scDrugMiceDas_annotated.RDS")
```
